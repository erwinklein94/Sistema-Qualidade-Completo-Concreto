...
function renderTabela(lista, total) {
  ...
  alvo.innerHTML = `<div class="tabela-wrap"><table class="tabela">
    <thead><tr>
      <th>Data</th><th>Lote</th><th>Projeto</th><th>Bitola</th><th>Pista / posição</th><th>Molde/Cav.</th>
      <th>Atividade</th><th>Não conformidades</th><th>Resultado</th><th>Relatório</th><th>Ações</th>
    </tr></thead>
