...
const App = {
  menuBase() {
    return [
      ...
      { k: 'ensaioEstaticoConcreto', t: 'Ensaio Estático Concreto', ic: ICN.ensaios, href: 'ensaio-estatico-concreto.html', group: 'concreto' },
      ...
      { k: 'comparativoCuraTermica', t: 'Comparativo Cura Térmica', ic: ICN.semanal, href: 'comparativo-cura-termica.html', group: 'concreto' },
...

      {
        sec: 'FERRAMENTAS',
        group: 'ferramentas',
        desc: 'Apoio aos fiscais: leitura, estudo e guia externo'
      },
